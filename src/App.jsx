        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="flex justify-center mb-4 md:mb-6 animate-slide-up">
            <img
              ...
              alt="Swim with Sairy"
              className="max-h-[18vh] sm:max-h-[42vh] md:max-h-[50vh] lg:max-h-[54vh] w-auto object-contain my-[-20vh] sm:my-[-10vh]"
            />
          </div>
...
'77479', '77498', '77478', '77406', '77469', '77407', '77459', '77489', '77083', '77072', '77494', '77471', '77036', '77082', '77099', '77071', 
];
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Users, text: 'No pool? No problem! I host lessons at local pools near me as well.' },
  ...
  const programs = [
    {
      ...
      image: 'https://i.postimg.cc/gjZ81gFJ/2c86c171-cae2-4b62-8985-5d2ef443a584.jpg',
      icon: Heart,
